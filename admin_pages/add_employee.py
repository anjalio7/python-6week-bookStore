...
class ADDEmployee:
    def __init__(self, window):
        ...
        self.sign_in_label = Label(self.lgn_frame, text="EMPLOYEE NAME", bg="#040405", fg="white",
...
#$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$     BUTTON      @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@2      
        ...
        self.sign_in_label6 = Button(self.lgn_frame, text="ADD EMPLOYEE", bg="BLUE", fg="white", command= self.loginUser , 
    ...
    def loginUser(self):
        ...
        if self.username_entry.get()  == '':
            ...
            res = database.AddEmployee(self.data)
            if res:        
