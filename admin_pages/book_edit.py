...
#$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$     BUTTON      @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@2      
        ...
        self.options2= database.singlerack()
        print(self.options)
        self.drop_Down2 = Combobox(self.window, textvariable=self.dropValue2, values= self.options2)
        self.drop_Down2.place(x=905,y=500 , height=34, width= 212)  

                # /////////////////////////////////////////////////////////////////////////
        # ///////////////////////////////GO BACK PHOTO ////////////////////////////
        # //////////////////////////////////////////////////////////////////////////
        self.lgn_button = Image.open('images\\addbook3.png')
        ...
        res = database.singlebook(self.id)
        print(res)
        if res:
            self.username_entry.insert(0, res[1])
            self.drop_Down.insert(0, res[2])
            self.username_entry3.insert(0, res[3])
            self.username_entry4.insert(0, res[4])
            self.drop_Down2.insert(0, res[5])
            self.username_entry6.insert(0, res[6])
        else:
    ...
    def loginUser(self):
        ...
        # elif (self.username_entry5.get().isdigit()):
            ...
            res = database.editbook(self.data)
            if res:        
