...
class EmployeeLogin:
    def __init__(self, window):
        ...
        # ============ Sign In label =============================================
        # ========================================================================
        self.sign_in_label = Label(self.lgn_frame, text="Employee Login ", bg="#040405", fg="white",
        ...
        self.login = Button(self.lgn_button_label, text='LOGIN', font=("yu gothic ui", 13, "bold" ), width=25, bd=0, command= self.loginUser , bg='#3047ff', cursor='hand2', activebackground='#3047ff', fg='white')
    ...
    def loginUser(self):
        ...
        if self.username_entry.get() == '':
            ...
            messagebox.showerror('Alert', 'Enter your pasword first.')
            ...
            res = database.employeeLogin(self.data)
            if res:
                messagebox.showinfo('Success', 'Login Successful.')
                self.EmployeeMenu(res)
            else:
                messagebox.showerror('Alert', 'Something went wrong.')
                
    def EmployeeMenu(self, res):
        obj = employee_menu.menupage(self.window, res)

def page():
    window = Toplevel()
    EmployeeLogin(window)
    window.mainloop()
